        ...
        <div className="hero-div">
            ...
            <div className="hero-framer">
                ...
                <div className="hero-text-div">
                    ...
                    <p className="disclaimer">**the reviews and features showcased on this landing page are for demonstration purposes only**</p>
                    <a onClick={() => setIsRegistering(true)} className="get-started hero-get-started">Get Started</a>
                </div>


                <div className="phone-framer mobile">
                    <div className="phone-top">
