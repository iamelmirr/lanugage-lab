...
const Home = (props) => {
    ...
    **Guidelines for Communication**:
    ...
    return (
        <>
        <Nav selectedMode={selectedMode} setSelectedMode={setSelectedMode} handleSelectedMode={handleSelectedMode} handleTabChange={handleTabChange} setActiveTab={setActiveTab} activeTab={activeTab} showOptionsModal={showOptionsModal} setShowOptionsModal={setShowOptionsModal} isChatCloseModalVisible={isChatCloseModalVisible} setIsChatCloseModalVisible={setIsChatCloseModalVisible} chatCloseMode={chatCloseMode} isChatCloseMode={isChatCloseMode}></Nav>
